"""
Django settings for luffa_prediction project.
...
ALLOWED_HOSTS = os.environ.get("ALLOWED_HOSTS", "127.0.0.1,localhost,luffalense.onrender.com").split(",")
...
ROOT_URLCONF = 'luffa_prediction.urls'
...
WSGI_APPLICATION = 'luffa_prediction.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [f"https://{host}" for host in ALLOWED_HOSTS if host != "127.0.0.1" and host != "localhost"]
